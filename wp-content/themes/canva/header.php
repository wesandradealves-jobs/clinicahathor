...
<head>
    ...
    <meta name="author" content="CAQO Marketing" />
    ...
    <!-- Document Title
    ============================================= -->
    <title><?php echo get_bloginfo('name').((!is_front_page()) ? ' - '.get_the_title()  : ' - '.get_bloginfo('description')); ?></title>
        ...
        <header id="header" class="full-header">
            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="<?php echo home_url(); ?>" class="standard-logo" data-dark-logo="<?php echo (get_theme_mod('darklogo')) ? get_theme_mod('darklogo') : get_stylesheet_directory_uri().'/demos/business/images/logo-dark.png'; ?>">
                            <img src="<?php echo (get_theme_mod('logo')) ? get_theme_mod('logo') : get_stylesheet_directory_uri().'/demos/business/images/logo-dark.png'; ?>" alt="<?php echo get_bloginfo('description'); ?>">
                        </a>

                        <!-- <a href="index.html" class="retina-logo" data-dark-logo="<?php echo get_stylesheet_directory_uri(); ?>/demos/business/images/logo-dark@2x.png"><img src="<?php echo get_stylesheet_directory_uri(); ?>/demos/business/images/logo@2x.png" alt="<?php echo get_bloginfo('description'); ?>"></a> -->
                    </div><!-- #logo end -->
                                ...
                                <div class="top-cart-items">
                                    <div class="top-cart-item clearfix">
                                        <div class="top-cart-item-image">
                                            <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/shop/small/1.jpg" alt="Blue Round-Neck Tshirt" /></a>
                                        </div>
                                    ...
                                    <div class="top-cart-item clearfix">
                                        <div class="top-cart-item-image">
                                            <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/shop/small/6.jpg" alt="Light Blue Denim Dress" /></a>
                                        </div>
                                        <div class="top-cart-item-desc">
