...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	?>
	<div id="login">
		<h1><a href="<?php echo home_url(); ?>"><img src="<?php echo (get_theme_mod('adminlogo')) ? get_theme_mod('adminlogo') : 'https://scontent.fsdu25-1.fna.fbcdn.net/v/t1.0-9/15622458_1863916230493726_442265706636758672_n.jpg?_nc_cat=106&_nc_sid=85a577&_nc_eui2=AeG1GyPIs-_wDTWErCyrqQSCbaYFgYdBBH1tpgWBh0EEfevxOmwAUpedUVboB0riWaTzMC5yQkPeEY_AfQQtpUV7&_nc_ohc=NwAt5c8zuRMAX8YooHq&_nc_ht=scontent.fsdu25-1.fna&oh=cbe6e005921101453a0b55efdb3bd495&oe=5F003D56' ?>"/></a></h1>
		<style>
			body {
				background-color: <?php echo (get_theme_mod('login_bg')) ? get_theme_mod('login_bg') : 'white'; ?> !important
			}
			.copyright,
			.login #backtoblog a, .login #nav a {
				color: <?php echo (get_theme_mod('colors')) ? get_theme_mod('colors') : 'black'; ?> !important
			}	
			#wp-submit {
				background: <?php echo (get_theme_mod('colors')) ? get_theme_mod('colors') : 'black'; ?> !important
			}		
			.dashicons-visibility:before {
				color: <?php echo (get_theme_mod('icons')) ? get_theme_mod('icons') : 'black'; ?> !important
			}
		</style>
	<?php
	/**
...
switch ( $action ) {
	...
	case 'retrievepassword':
		...
		<p class="copyright">desenvolvido por CAQO</p>
		<p id="nav">
